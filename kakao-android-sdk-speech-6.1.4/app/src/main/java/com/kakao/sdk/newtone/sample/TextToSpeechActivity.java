    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonStartStop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int sampleRate;
                RadioGroup radioSampleRate = (RadioGroup)findViewById(R.id.sampleRateRadioGroup);
                switch(radioSampleRate.getCheckedRadioButtonId()){
                    case R.id.samplerate16000:
                        sampleRate = 16000;
                        break;
                    case R.id.samplerate22050:
                    default:
                        sampleRate = 22050;
                        break;
                }
